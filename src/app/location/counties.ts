...
export const countries = [
  ...
  { name: 'Åland Islands (Åland)', code: 'ax', flag: 'ax', callingCode: ' ' },
  { name: 'Albania (Shqipëri)', code: 'al', flag: 'al', callingCode: ' ' },
  { name: 'Algeria (‫الجزائر‬‎)', code: 'dz', flag: 'dz', callingCode: ' ' },
  { name: 'American Samoa', code: 'as', flag: 'as', callingCode: ' ' },
  { name: 'Andorra', code: 'ad', flag: 'ad', callingCode: ' ' },
  { name: 'Angola', code: 'ao', flag: 'ao', callingCode: ' ' },
  { name: 'Anguilla', code: 'ai', flag: 'ai', callingCode: ' ' },
  { name: 'Antigua and Barbuda', code: 'ag', flag: 'ag', callingCode: ' ' },
  { name: 'Argentina', code: 'ar', flag: 'ar', callingCode: ' ' },
  { name: 'Armenia (Հայաստան)', code: 'am', flag: 'am', callingCode: ' ' },
  { name: 'Aruba', code: 'aw', flag: 'aw', callingCode: ' ' },
  { name: 'Australia', code: 'au', flag: 'au', callingCode: ' ' },
  { name: 'Austria (Österreich)', code: 'at', flag: 'at', callingCode: ' ' },
  { name: 'Azerbaijan (Azərbaycan)', code: 'az', flag: 'az', callingCode: ' ' },
  { name: 'Bahamas', code: 'bs', flag: 'bs', callingCode: ' ' },
  { name: 'Bahrain (‫البحرين‬‎)', code: 'bh', flag: 'bh', callingCode: ' ' },
  { name: 'Bangladesh (বাংলাদেশ)', code: 'bd', flag: 'bd', callingCode: ' ' },
  { name: 'Barbados', code: 'bb', flag: 'bb', callingCode: ' ' },
  { name: 'Belarus (Беларусь)', code: 'by', flag: 'by', callingCode: ' ' },
  { name: 'Belgium (België)', code: 'be', flag: 'be', callingCode: ' ' },
  { name: 'Belize', code: 'bz', flag: 'bz', callingCode: ' ' },
  { name: 'Benin (Bénin)', code: 'bj', flag: 'bj', callingCode: ' ' },
  { name: 'Bermuda', code: 'bm', flag: 'bm', callingCode: ' ' },
  { name: 'Bhutan (འབྲུག)', code: 'bt', flag: 'bt', callingCode: ' ' },
  { name: 'Bolivia', code: 'bo', flag: 'bo', callingCode: ' ' },
  {
  ...
  { name: 'Botswana', code: 'bw', flag: 'bw', callingCode: ' ' },
  { name: 'Brazil (Brasil)', code: 'br', flag: 'br', callingCode: ' ' },
  {
  ...
  { name: 'British Virgin Islands', code: 'vg', flag: 'vg', callingCode: ' ' },
  { name: 'Brunei', code: 'bn', flag: 'bn', callingCode: ' ' },
  { name: 'Bulgaria (България)', code: 'bg', flag: 'bg', callingCode: ' ' },
  { name: 'Burkina Faso', code: 'bf', flag: 'bf', callingCode: ' ' },
  { name: 'Burundi (Uburundi)', code: 'bi', flag: 'bi', callingCode: ' ' },
  { name: 'Cambodia (កម្ពុជា)', code: 'kh', flag: 'kh', callingCode: ' ' },
  { name: 'Cameroon (Cameroun)', code: 'cm', flag: 'cm', callingCode: ' ' },
  { name: 'Canada', code: 'ca', flag: 'ca', callingCode: ' ' },
  { name: 'Cape Verde (Kabu Verdi)', code: 'cv', flag: 'cv', callingCode: ' ' },
  { name: 'Caribbean Netherlands', code: 'bq', flag: 'bq', callingCode: ' ' },
  { name: 'Cayman Islands', code: 'ky', flag: 'ky', callingCode: ' ' },
  {
  ...
  { name: 'Chad (Tchad)', code: 'td', flag: 'td', callingCode: ' ' },
  { name: 'Chile', code: 'cl', flag: 'cl', callingCode: ' ' },
  { name: 'China (中国)', code: 'cn', flag: 'cn', callingCode: ' ' },
  { name: 'Christmas Island', code: 'cx', flag: 'cx', callingCode: ' ' },
  {
  ...
  { name: 'Colombia', code: 'co', flag: 'co', callingCode: ' ' },
  { name: 'Comoros (‫جزر القمر‬‎)', code: 'km', flag: 'km', callingCode: ' ' },
  {
  ...
  { name: 'Cook Islands', code: 'ck', flag: 'ck', callingCode: ' ' },
  { name: 'Costa Rica', code: 'cr', flag: 'cr', callingCode: ' ' },
  { name: 'Côte d’Ivoire', code: 'ci', flag: 'ci', callingCode: ' ' },
  { name: 'Croatia (Hrvatska)', code: 'hr', flag: 'hr', callingCode: ' ' },
  { name: 'Cuba', code: 'cu', flag: 'cu', callingCode: ' ' },
  { name: 'Curaçao', code: 'cw', flag: 'cw', callingCode: ' ' },
  { name: 'Cyprus (Κύπρος)', code: 'cy', flag: 'cy', callingCode: ' ' },
  {
  ...
  { name: 'Denmark (Danmark)', code: 'dk', flag: 'dk', callingCode: ' ' },
  { name: 'Djibouti', code: 'dj', flag: 'dj', callingCode: ' ' },
  { name: 'Dominica', code: 'dm', flag: 'dm', callingCode: ' ' },
  {
  ...
  { name: 'Ecuador', code: 'ec', flag: 'ec', callingCode: ' ' },
  { name: 'Egypt (‫مصر‬‎)', code: 'eg', flag: 'eg', callingCode: ' ' },
  { name: 'El Salvador', code: 'sv', flag: 'sv', callingCode: ' ' },
  {
  ...
  { name: 'Eritrea', code: 'er', flag: 'er', callingCode: ' ' },
  { name: 'Estonia (Eesti)', code: 'ee', flag: 'ee', callingCode: ' ' },
  { name: 'Ethiopia', code: 'et', flag: 'et', callingCode: ' ' },
  {
  ...
  { name: 'Faroe Islands (Føroyar)', code: 'fo', flag: 'fo', callingCode: ' ' },
  { name: 'Fiji', code: 'fj', flag: 'fj', callingCode: ' ' },
  { name: 'Finland (Suomi)', code: 'fi', flag: 'fi', callingCode: ' ' },
  { name: 'France', code: 'fr', flag: 'fr', callingCode: ' ' },
  {
  ...
  { name: 'Gabon', code: 'ga', flag: 'ga', callingCode: ' ' },
  { name: 'Gambia', code: 'gm', flag: 'gm', callingCode: ' ' },
  { name: 'Georgia (საქართველო)', code: 'ge', flag: 'ge', callingCode: ' ' },
  { name: 'Germany (Deutschland)', code: 'de', flag: 'de', callingCode: ' ' },
  { name: 'Ghana (Gaana)', code: 'gh', flag: 'gh', callingCode: ' ' },
  { name: 'Gibraltar', code: 'gi', flag: 'gi', callingCode: ' ' },
  { name: 'Greece (Ελλάδα)', code: 'gr', flag: 'gr', callingCode: ' ' },
  {
  ...
  { name: 'Grenada', code: 'gd', flag: 'gd', callingCode: ' ' },
  { name: 'Guadeloupe', code: 'gp', flag: 'gp', callingCode: ' ' },
  { name: 'Guam', code: 'gu', flag: 'gu', callingCode: ' ' },
  { name: 'Guatemala', code: 'gt', flag: 'gt', callingCode: ' ' },
  { name: 'Guernsey', code: 'gg', flag: 'gg', callingCode: ' ' },
  { name: 'Guinea (Guinée)', code: 'gn', flag: 'gn', callingCode: ' ' },
  {
  ...
  { name: 'Guyana', code: 'gy', flag: 'gy', callingCode: ' ' },
  { name: 'Haiti', code: 'ht', flag: 'ht', callingCode: ' ' },
  { name: 'Honduras', code: 'hn', flag: 'hn', callingCode: ' ' },
  { name: 'Hong Kong (香港)', code: 'hk', flag: 'hk', callingCode: ' ' },
  { name: 'Hungary (Magyarország)', code: 'hu', flag: 'hu', callingCode: ' ' },
  { name: 'Iceland (Ísland)', code: 'is', flag: 'is', callingCode: ' ' },
  { name: 'India (भारत)', code: 'in', flag: 'in', callingCode: ' ' },
  { name: 'Indonesia', code: 'id', flag: 'id', callingCode: ' ' },
  { name: 'Iran (‫ایران‬‎)', code: 'ir', flag: 'ir', callingCode: ' ' },
  { name: 'Iraq (‫العراق‬‎)', code: 'iq', flag: 'iq', callingCode: ' ' },
  { name: 'Ireland', code: 'ie', flag: 'ie', callingCode: ' ' },
  { name: 'Isle of Man', code: 'im', flag: 'im', callingCode: ' ' },
  { name: 'Israel (‫ישראל‬‎)', code: 'il', flag: 'il', callingCode: ' ' },
  { name: 'Italy (Italia)', code: 'it', flag: 'it', callingCode: ' ' },
  { name: 'Jamaica', code: 'jm', flag: 'jm', callingCode: ' ' },
  { name: 'Japan (日本)', code: 'jp', flag: 'jp', callingCode: ' ' },
  { name: 'Jersey', code: 'je', flag: 'je', callingCode: ' ' },
  { name: 'Jordan (‫الأردن‬‎)', code: 'jo', flag: 'jo', callingCode: ' ' },
  { name: 'Kazakhstan (Казахстан)', code: 'kz', flag: 'kz', callingCode: ' ' },
  { name: 'Kenya', code: 'ke', flag: 'ke', callingCode: ' ' },
  { name: 'Kiribati', code: 'ki', flag: 'ki', callingCode: ' ' },
  { name: 'Kosovo (Kosovë)', code: 'xk', flag: 'xk', callingCode: ' ' },
  { name: 'Kuwait (‫الكويت‬‎)', code: 'kw', flag: 'kw', callingCode: ' ' },
  { name: 'Kyrgyzstan (Кыргызстан)', code: 'kg', flag: 'kg', callingCode: ' ' },
  { name: 'Laos (ລາວ)', code: 'la', flag: 'la', callingCode: ' ' },
  { name: 'Latvia (Latvija)', code: 'lv', flag: 'lv', callingCode: ' ' },
  { name: 'Lebanon (‫لبنان‬‎)', code: 'lb', flag: 'lb', callingCode: ' ' },
  { name: 'Lesotho', code: 'ls', flag: 'ls', callingCode: ' ' },
  { name: 'Liberia', code: 'lr', flag: 'lr', callingCode: ' ' },
  { name: 'Libya (‫ليبيا‬‎)', code: 'ly', flag: 'ly', callingCode: ' ' },
  { name: 'Liechtenstein', code: 'li', flag: 'li', callingCode: ' ' },
  { name: 'Lithuania (Lietuva)', code: 'lt', flag: 'lt', callingCode: ' ' },
  { name: 'Luxembourg', code: 'lu', flag: 'lu', callingCode: ' ' },
  { name: 'Macau (澳門)', code: 'mo', flag: 'mo', callingCode: ' ' },
  {
  ...
  { name: 'Malawi', code: 'mw', flag: 'mw', callingCode: ' ' },
  { name: 'Malaysia', code: 'my', flag: 'my', callingCode: ' ' },
  { name: 'Maldives', code: 'mv', flag: 'mv', callingCode: ' ' },
  { name: 'Mali', code: 'ml', flag: 'ml', callingCode: ' ' },
  { name: 'Malta', code: 'mt', flag: 'mt', callingCode: ' ' },
  { name: 'Marshall Islands', code: 'mh', flag: 'mh', callingCode: ' ' },
  { name: 'Martinique', code: 'mq', flag: 'mq', callingCode: ' ' },
  {
  ...
  { name: 'Mauritius (Moris)', code: 'mu', flag: 'mu', callingCode: ' ' },
  { name: 'Mayotte', code: 'yt', flag: 'yt', callingCode: ' ' },
  { name: 'Mexico (México)', code: 'mx', flag: 'mx', callingCode: ' ' },
  { name: 'Micronesia', code: 'fm', flag: 'fm', callingCode: ' ' },
  {
  ...
  { name: 'Monaco', code: 'mc', flag: 'mc', callingCode: ' ' },
  { name: 'Mongolia (Монгол)', code: 'mn', flag: 'mn', callingCode: ' ' },
  { name: 'Montenegro (Crna Gora)', code: 'me', flag: 'me', callingCode: ' ' },
  { name: 'Montserrat', code: 'ms', flag: 'ms', callingCode: ' ' },
  { name: 'Morocco (‫المغرب‬‎)', code: 'ma', flag: 'ma', callingCode: ' ' },
  { name: 'Mozambique (Moçambique)', code: 'mz', flag: 'mz', callingCode: ' ' },
  {
  ...
  { name: 'Namibia (Namibië)', code: 'na', flag: 'na', callingCode: ' ' },
  { name: 'Nauru', code: 'nr', flag: 'nr', callingCode: ' ' },
  { name: 'Nepal (नेपाल)', code: 'np', flag: 'np', callingCode: ' ' },
  { name: 'Netherlands (Nederland)', code: 'nl', flag: 'nl', callingCode: ' ' },
  {
  ...
  { name: 'New Zealand', code: 'nz', flag: 'nz', callingCode: ' ' },
  { name: 'Nicaragua', code: 'ni', flag: 'ni', callingCode: ' ' },
  { name: 'Niger (Nijar)', code: 'ne', flag: 'ne', callingCode: ' ' },
  { name: 'Nigeria', code: 'ng', flag: 'ng', callingCode: ' ' },
  { name: 'Niue', code: 'nu', flag: 'nu', callingCode: ' ' },
  { name: 'Norfolk Island', code: 'nf', flag: 'nf', callingCode: ' ' },
  {
  ...
  { name: 'Norway (Norge)', code: 'no', flag: 'no', callingCode: ' ' },
  { name: 'Oman (‫عُمان‬‎)', code: 'om', flag: 'om', callingCode: ' ' },
  { name: 'Pakistan (‫پاکستان‬‎)', code: 'pk', flag: 'pk', callingCode: ' ' },
  { name: 'Palau', code: 'pw', flag: 'pw', callingCode: ' ' },
  { name: 'Palestine (‫فلسطين‬‎)', code: 'ps', flag: 'ps', callingCode: ' ' },
  { name: 'Panama (Panamá)', code: 'pa', flag: 'pa', callingCode: ' ' },
  { name: 'Papua New Guinea', code: 'pg', flag: 'pg', callingCode: ' ' },
  { name: 'Paraguay', code: 'py', flag: 'py', callingCode: ' ' },
  { name: 'Peru (Perú)', code: 'pe', flag: 'pe', callingCode: ' ' },
  { name: 'Philippines', code: 'ph', flag: 'ph', callingCode: ' ' },
  { name: 'Pitcairn Islands', code: 'pn', flag: 'pn', callingCode: ' ' },
  { name: 'Poland (Polska)', code: 'pl', flag: 'pl', callingCode: ' ' },
  { name: 'Portugal', code: 'pt', flag: 'pt', callingCode: ' ' },
  { name: 'Puerto Rico', code: 'pr', flag: 'pr', callingCode: ' ' },
  { name: 'Qatar (‫قطر‬‎)', code: 'qa', flag: 'qa', callingCode: ' ' },
  { name: 'Réunion (La Réunion)', code: 're', flag: 're', callingCode: ' ' },
  { name: 'Romania (România)', code: 'ro', flag: 'ro', callingCode: ' ' },
  { name: 'Russia (Россия)', code: 'ru', flag: 'ru', callingCode: ' ' },
  { name: 'Rwanda', code: 'rw', flag: 'rw', callingCode: ' ' },
  {
  ...
  { name: 'Saint Helena', code: 'sh', flag: 'sh', callingCode: ' ' },
  { name: 'Saint Kitts and Nevis', code: 'kn', flag: 'kn', callingCode: ' ' },
  { name: 'Saint Lucia', code: 'lc', flag: 'lc', callingCode: ' ' },
  {
  ...
  { name: 'Samoa', code: 'ws', flag: 'ws', callingCode: ' ' },
  { name: 'San Marino', code: 'sm', flag: 'sm', callingCode: ' ' },
  {
  ...
  { name: 'Senegal (Sénégal)', code: 'sn', flag: 'sn', callingCode: ' ' },
  { name: 'Serbia (Србија)', code: 'rs', flag: 'rs', callingCode: ' ' },
  { name: 'Seychelles', code: 'sc', flag: 'sc', callingCode: ' ' },
  { name: 'Sierra Leone', code: 'sl', flag: 'sl', callingCode: ' ' },
  { name: 'Singapore', code: 'sg', flag: 'sg', callingCode: ' ' },
  { name: 'Sint Maarten', code: 'sx', flag: 'sx', callingCode: ' ' },
  { name: 'Slovakia (Slovensko)', code: 'sk', flag: 'sk', callingCode: ' ' },
  { name: 'Slovenia (Slovenija)', code: 'si', flag: 'si', callingCode: ' ' },
  { name: 'Solomon Islands', code: 'sb', flag: 'sb', callingCode: ' ' },
  { name: 'Somalia (Soomaaliya)', code: 'so', flag: 'so', callingCode: ' ' },
  { name: 'South Africa', code: 'za', flag: 'za', callingCode: ' ' },
  {
  ...
  { name: 'South Korea (대한민국)', code: 'kr', flag: 'kr', callingCode: ' ' },
  {
  ...
  { name: 'Spain (España)', code: 'es', flag: 'es', callingCode: ' ' },
  { name: 'Sri Lanka (ශ්‍රී ලංකාව)', code: 'lk', flag: 'lk', callingCode: ' ' },
  { name: 'Sudan (‫السودان‬‎)', code: 'sd', flag: 'sd', callingCode: ' ' },
  { name: 'Suriname', code: 'sr', flag: 'sr', callingCode: ' ' },
  {
  ...
  {
    name: 'Swaziland (Kingdom of eSwatini)',
    code: 'sz',
    flag: 'sz',
    callingCode: ' ',
  },
  { name: 'Sweden (Sverige)', code: 'se', flag: 'se', callingCode: ' ' },
  {
  ...
  { name: 'Syria (‫سوريا‬‎)', code: 'sy', flag: 'sy', callingCode: ' ' },
  { name: 'Taiwan (台灣)', code: 'tw', flag: 'tw', callingCode: ' ' },
  { name: 'Tajikistan', code: 'tj', flag: 'tj', callingCode: ' ' },
  { name: 'Tanzania', code: 'tz', flag: 'tz', callingCode: ' ' },
  { name: 'Thailand (ไทย)', code: 'th', flag: 'th', callingCode: ' ' },
  { name: 'Timor-Leste', code: 'tl', flag: 'tl', callingCode: ' ' },
  { name: 'Togo', code: 'tg', flag: 'tg', callingCode: ' ' },
  { name: 'Tokelau', code: 'tk', flag: 'tk', callingCode: ' ' },
  { name: 'Tonga', code: 'to', flag: 'to', callingCode: ' ' },
  { name: 'Trinidad and Tobago', code: 'tt', flag: 'tt', callingCode: ' ' },
  { name: 'Tunisia (‫تونس‬‎)', code: 'tn', flag: 'tn', callingCode: ' ' },
  { name: 'Turkey (Türkiye)', code: 'tr', flag: 'tr', callingCode: ' ' },
  { name: 'Turkmenistan', code: 'tm', flag: 'tm', callingCode: ' ' },
  {
  ...
  { name: 'Tuvalu', code: 'tv', flag: 'tv', callingCode: ' ' },
  { name: 'Uganda', code: 'ug', flag: 'ug', callingCode: ' ' },
  { name: 'Ukraine (Україна)', code: 'ua', flag: 'ua', callingCode: ' ' },
  {
  ...
  { name: 'United Kingdom', code: 'gb', flag: 'gb', callingCode: ' ' },
  { name: 'United States', code: 'us', flag: 'us', callingCode: ' ' },
  {
  ...
  { name: 'U.S. Virgin Islands', code: 'vi', flag: 'vi', callingCode: ' ' },
  { name: 'Uruguay', code: 'uy', flag: 'uy', callingCode: ' ' },
  {
  ...
  { name: 'Vanuatu', code: 'vu', flag: 'vu', callingCode: ' ' },
  {
  ...
  { name: 'Venezuela', code: 've', flag: 've', callingCode: ' ' },
  { name: 'Vietnam (Việt Nam)', code: 'vn', flag: 'vn', callingCode: ' ' },
  { name: 'Wallis and Futuna', code: 'wf', flag: 'wf', callingCode: ' ' },
  {
  ...
  { name: 'Yemen (‫اليمن‬‎)', code: 'ye', flag: 'ye', callingCode: ' ' },
  { name: 'Zambia', code: 'zm', flag: 'zm', callingCode: ' ' },
  { name: 'Zimbabwe', code: 'zw', flag: 'zw', callingCode: ' ' },
];
